<div class="modal fade" id="edit-province" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="button-modal-edit-province">Sửa</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#button-modal-edit-province').click(function() {
                var name = $('#edit-province input[name="name"]').val();
                var code = $('#edit-province input[name="code"]').val();
                var id = $('#edit-province input[name="id"]').val();
                var message = '';
