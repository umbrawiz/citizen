                    ...
                    },
                    {
                        ...
                        render: function(id) {
                            ...
                            if (user.type == 'B1' || user.type == 'B2') {
                                if (user.type == 'B1') {
                                    return `
                                        <button data-id="${id}" id="button-edit-declaration" data-toggle="modal" data-target="#edit-testdeclaration" class="btn-primary">
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.status == '200') {
                            $('#edit-testdeclaration input[name="name"]').val(response.data.name);
                            $('#edit-testdeclaration input[name="identity_card"]').val(response.data.identity_card);
                            $('#edit-testdeclaration input[name="birthday"]').val(response.data.birthday);
                            $('#edit-testdeclaration input[name="country"]').val(response.data.country);
                            $('#edit-testdeclaration input[name="permanent_address"]').val(response.data.permanent_address);
                            $('#edit-testdeclaration input[name="temporary_address"]').val(response.data.temporary_address);
                            $('#edit-testdeclaration input[name="education"]').val(response.data.education);
                            $('#edit-testdeclaration input[name="job"]').val(response.data.job);
                            $('#edit-testdeclaration input[name="id"]').val(id);
