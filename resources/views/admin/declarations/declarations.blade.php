                        ...
                        <tbody align="center">
                            ...
                            @foreach ($declarations as $declaration)
                                <tr>
                                    ...
                                    <td>{{ $declaration->religion == 0 ? 'Phật giáo' : ($declaration->religion == 1 ? 'Thiên chúa giáo' : 'Khác') }}
                                    </td>
                                    <td>{{ $declaration->education }}</td>
                                    <td>{{ $declaration->job }}</td>
                                    <td>
                                        <a href="javascript:void(0)"
                                            onclick="deleteDeclaration({{ $declaration->id }});"><i
                                                class="fa fa-times" aria-hidden="true"></i></a>
                                        <a href="javascript:void(0)" onclick="showFormEditDeclaration({{ $declaration->id }})"
                                            style="margin:0 1rem;"><i class="fa fa-pencil-square-o"
