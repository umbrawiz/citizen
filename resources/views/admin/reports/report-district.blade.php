...
<body>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $.ajax({
                url: '{{ route('api.sum.declaration.district') }}',
                type: 'GET',
                headers: {
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(code) {
                            return `
                                <button data-code="${code}" id="button-show-district">
            ...
            $("#wrapper").on('click', '#button-show-district', function() {

                const code = $(this).data('code');

                $.ajax({
                    url: '{{ route('api.show.declaration.district') }}',
                    type: 'GET',
                    data: {
                        code: code
                    },
                    ...
                    success: function(response) {
                        if (response.status == '200') {
                            window.history.pushState('', '', '/show-district?code='+code);
